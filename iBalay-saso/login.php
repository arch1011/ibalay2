          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="d-flex justify-content-center py-4">
                <a href="/iBalay.com/iBalay-saso/index.php" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/evsu.png" alt="">
                  <span class="d-none d-lg-block"> iBalay - SASO</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Welcome Back! Sign in!</h5>
