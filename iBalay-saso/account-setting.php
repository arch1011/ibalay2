...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="container d-flex justify-content-cente card col-6">
    <div class="card-body">
        <h5 class="card-title">Update SASO Account</h5>

        <!-- Update Account Form -->
        <form action="update-account.php" method="post" enctype="multipart/form-data" class="row g-3">
            <div class="col-12">
